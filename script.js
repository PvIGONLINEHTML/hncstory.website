class Game {
  ...
  * Display score
   ...
   */
  showGrade(score) {
	  if (score > 30) return "你是大佬";else
	  if (score > 25) return "難以置信的";else
	  if (score > 20) return "驚人的";else
	  if (score > 15) return "很棒的!";else
	  if (score > 13) return "很好!";else
	  if (score > 10) return "幹得好!";else
	  if (score > 5) return "真的嗎?";else
	  return "差勁...";
  }
